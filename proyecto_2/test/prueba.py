...
if __name__ == "__main__":
    input_csv = "Situaci_n_V_ctimas_Minas_Antipersonal_en_Colombia_20240103.csv"
    output_csv = "Situaci_n_V_ctimas_Minas_Antipersonal_en_Colombia_20240103_resultado.csv"
